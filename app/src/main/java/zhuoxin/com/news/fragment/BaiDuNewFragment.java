...
public class BaiDuNewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        contentView = inflater.inflate(R.layout.activity_new_text, container, false);
        // 获取传入的参数
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        recyclerView = (RecyclerView) view.findViewById(R.id.new_baidu_rc);
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.new_baidu_srl);
        //下拉监听
        //下拉刷新的色彩配置。最多可以设置四种颜色
        swipeRefreshLayout.setColorSchemeResources(R.color.cardview_light_background, R.color.colorAccent, R.color.cardview_dark_background, R.color.colorPrimary);
        ...
        adapter.setLoadingLinener(new BaseLoadingAdapter.LoadingLinener() {
            @Override
            public void Loading() {
    ...
    private void getBaiduNewInfo(final int getDataType, int pager) {
        StringRequest stringRequest = new StringRequest(ConnectionURL.findNewsByName(newName, nowPage), new Response.Listener<String>() {
            @Override
